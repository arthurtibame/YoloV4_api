...
from app.utils.yolo4.model import yolo_eval, yolo4_body
from app.utils.yolo4.utils import letterbox_image
...
class Yolo4(object):
    ...
    def detect_image(self, image, model_image_size=(608, 608)):
        ...
        font = ImageFont.truetype(font='./app/utils/font/FiraMono-Medium.otf',
